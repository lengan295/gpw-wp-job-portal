...
class WPJOBPORTALjobssearchjobs_widget extends WP_Widget {
    ...
    public function update($new_instance, $old_instance) {
        ...
        $instance['title'] = (!empty($new_instance['title'])) ? esc_attr(wp_strip_all_tags($new_instance['title'])) : '';
        $instance['showtitle'] = (!empty($new_instance['showtitle'])) ? esc_attr(wp_strip_all_tags($new_instance['showtitle'])) : '';
        $instance['jobtitle'] = (!empty($new_instance['jobtitle'])) ? esc_attr(wp_strip_all_tags($new_instance['jobtitle'])) : '';
        $instance['category'] = (!empty($new_instance['category'])) ? esc_attr(wp_strip_all_tags($new_instance['category'])) : '';

        $instance['jobtype'] = (!empty($new_instance['jobtype'])) ? esc_attr(wp_strip_all_tags($new_instance['jobtype'])) : '';
        $instance['jobstatus'] = (!empty($new_instance['jobstatus'])) ? esc_attr(wp_strip_all_tags($new_instance['jobstatus'])) : '';
        $instance['salaryrange'] = (!empty($new_instance['salaryrange'])) ? esc_attr(wp_strip_all_tags($new_instance['salaryrange'])) : '';
        $instance['shift'] = (!empty($new_instance['shift'])) ? esc_attr(wp_strip_all_tags($new_instance['shift'])) : '';
        $instance['duration'] = (!empty($new_instance['duration'])) ? esc_attr(wp_strip_all_tags($new_instance['duration'])) : '';
        $instance['company'] = (!empty($new_instance['company'])) ? esc_attr(wp_strip_all_tags($new_instance['company'])) : '';
        $instance['address'] = (!empty($new_instance['address'])) ? esc_attr(wp_strip_all_tags($new_instance['address'])) : '';
        $instance['columnperrow'] = (!empty($new_instance['columnperrow'])) ? esc_attr(wp_strip_all_tags($new_instance['columnperrow'])) : '';
