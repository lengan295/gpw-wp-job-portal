    ...
    <div id="wpjobportaladmin-data">
            ...
            <div id="wpjobportal-wrapper-top-left">
                <div id="wpjobportal-breadcrumbs">
                    <ul>
                        ...
                        <li><?php echo esc_html(__('Career Levels','wp-job-portal')); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <form class="wpjobportal-filter-form" name="wpjobportalform" id="wpjobportalform" method="post" action="<?php echo esc_url_raw(admin_url("admin.php?page=wpjobportal_careerlevel")); ?>">
                <?php WPJOBPORTALincluder::getTemplate('careerlevel/views/filter') ?>
            </form>
            <?php
                if (!empty(wpjobportal::$_data[0])) {
                    ?>
                    <form id="wpjobportal-list-form" method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=wpjobportal_careerlevel&task=saveordering"),'wpjobportal_careerlevel_nonce')); ?>">
