...
class WPJOBPORTALCareerlevelController {
    ...
    function handleRequest() {
        ...
        if (self::canaddfile($layout)) {
            ...
            $module = WPJOBPORTALrequest::getVar($module, null, 'careerlevel');
    ...
    function savecareerlevel() {
        ...
        $url = esc_url_raw(admin_url("admin.php?page=wpjobportal_careerlevel&wpjobportallt=careerlevels"));
        wp_redirect($url);
        die();
    }
    ...
    function remove() {
        ...
        $msg = WPJOBPORTALMessages::getMessage($result, 'careerlevel');
        WPJOBPORTALMessages::setLayoutMessage($msg['message'], $msg['status'],$this->_msgkey);
        wp_redirect(esc_url_raw(admin_url("admin.php?page=wpjobportal_careerlevel&wpjobportallt=careerlevels")));
        die();
    }
    ...
    function saveordering(){
        ...
        $url = esc_url_raw(admin_url("admin.php?page=wpjobportal_careerlevel"));
        wp_redirect($url);
        exit;
    }
