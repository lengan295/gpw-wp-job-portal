...
<?php
    ...
    function changeCombo() {
     ...
     function getPackagePopup(resumeid) {
        ...
        jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'featureresume', task: 'getPackagePopupForFeaturedResume', wpjobportalid: resumeid, '_wpnonce':'". esc_attr(wp_create_nonce("get-package-popup-for-featured-resume"))."',wpjobportalpageid:jppage_id}, function (data) {
            if (data) {
