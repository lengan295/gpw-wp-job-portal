...
<?php
    $inline_js_script = "
        ...
        function getPopupAjax(category,categorytitle){
            ...
            jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'category', task: 'getsubcategorypopup', category: category, resume:1, page_id:page_id, '_wpnonce':'". esc_attr(wp_create_nonce("get-subcategory-popup"))."'}, function (data) {
                if (data) {
