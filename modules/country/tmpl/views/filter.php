...
*/
?>
<?php echo wp_kses(WPJOBPORTALformfield::text('countryname', wpjobportal::$_data['filter']['countryname'], array('class' => 'inputbox wpjobportal-form-input-field', 'placeholder' => esc_html(__('Name', 'wp-job-portal')))),WPJOBPORTAL_ALLOWED_TAGS); ?>
...
<div class="wpjobportal-form-checkbox-field">
	<?php echo wp_kses(WPJOBPORTALformfield::checkbox('states', array('1' => esc_html(__('Has states', 'wp-job-portal'))), isset(wpjobportal::$_data['filter']['states']) ? wpjobportal::$_data['filter']['states'] : 0, array('class' => 'checkbox')),WPJOBPORTAL_ALLOWED_TAGS); ?>
</div>
<div class="wpjobportal-form-checkbox-field">
