...
<tr id="id_<?php echo esc_attr($row->id);?>">
    ...
    <td class="wpjobportal-text-left">
        <a href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_highesteducation&wpjobportallt=formhighesteducation&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('title','wp-job-portal')); ?>">
    ...
    <td>
        ...
        <?php } else { ?>
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_common&task=makedefault&action=wpjobportaltask&for=heighesteducation&id='.$row->id.$pageid),'wpjobportal_common_entity_nonce')); ?>" title="<?php echo esc_html(__('not default','wp-job-portal')); ?>">
    ...
    <td>
        <?php if ($row->isactive == 1) { ?> 
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_highesteducation&task=unpublish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid),'wpjobportal_highest_education_nonce')); ?>" title="<?php echo esc_html(__('published', 'wp-job-portal')); ?>">
        ...
        <?php } else { ?>
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_highesteducation&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid),'wpjobportal_highest_education_nonce')); ?>" title="<?php echo esc_html(__('not published', 'wp-job-portal')); ?>">
    ...
    <td>
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_highesteducation&wpjobportallt=formhighesteducation&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('edit', 'wp-job-portal')); ?>">
        ...
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_highesteducation&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'wpjobportal_highest_education_nonce')); ?>" onclick='return confirmdelete("<?php echo esc_html(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_html(__('delete', 'wp-job-portal')); ?>">
