...
<tr>
    ...
    <td>
       ...
       <?php } else { ?>
	        <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_state&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)),'wpjobportal_state_nonce'); ?>" title="<?php echo esc_html(__('not published', 'wp-job-portal')); ?>">
    ...
    <td>
        <a href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_city&stateid='.esc_attr($row->id).'&countryid='.esc_attr($row->countryid))); ?>" title="<?php echo esc_html(__('cities', 'wp-job-portal')); ?>">
    ...
    <td>
        ...
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_state&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'wpjobportal_state_nonce')); ?>" onclick='return confirmdelete("<?php echo esc_html(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_html(__('delete', 'wp-job-portal')); ?>">
