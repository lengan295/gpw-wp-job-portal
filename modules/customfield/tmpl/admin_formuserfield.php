    ...
    <div id="wpjobportaladmin-data">
            ...
            <div id="wpjobportal-wrapper-top-left">
                <div id="wpjobportal-breadcrumbs">
                    <ul>
                        ...
                        <li><?php echo esc_html(__('Add User Field','wp-job-portal')); ?></li>
                    </ul>
                </div>
            </div>    
        ...
        $equalnotequal = array(
            ...
            if(isset(wpjobportal::$_data[0]['userfield']->userfieldtype)){
                ...
                $fieldtypes = array(
                    ...
                    (object) array('id' => 'radio', 'text' => esc_html(__('Radio Button', 'wp-job-portal'))),
                    (object) array('id' => 'textarea', 'text' => esc_html(__('Text Area', 'wp-job-portal'))),
                    //(object) array('id' => 'depandant_field', 'text' => esc_html(__('Dependent Field', 'wp-job-portal'))),
        ...
        <div id="wpjobportal-admin-wrapper">
            <form id="wpjobportal-form" class="wpjobportal-form" method="post" action="<?php echo esc_url_raw(admin_url("admin.php?page=wpjobportal_fieldordering&task=saveuserfield")); ?>">
                ...
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo esc_html(__('Field Title', 'wp-job-portal')); ?><span style="color: red;">*</span></div>
                    <div class="wpjobportal-form-value"><?php echo wp_kses(WPJOBPORTALformfield::text('fieldtitle', isset(wpjobportal::$_data[0]['userfield']->fieldtitle) ? esc_html(wpjobportal::$_data[0]['userfield']->fieldtitle) : '', array('class' => 'inputbox one wpjobportal-form-input-field', 'data-validation' => 'required')),WPJOBPORTAL_ALLOWED_TAGS); ?></div>
                </div>
                ...
                <?php if (wpjobportal::$_data[0]['fieldfor'] == 3) { ?>
                    <div class="wpjobportal-form-wrapper">
                        <div class="wpjobportal-form-title"><?php echo esc_html(__('Resume Section', 'wp-job-portal')); ?><span style="color: red;">*</span></div>
                ...
                <?php } ?>
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo esc_html(__('Place Holder', 'wp-job-portal')); ?></div>
                    <div class="wpjobportal-form-value"><?php echo wp_kses(WPJOBPORTALformfield::text('placeholder', isset(wpjobportal::$_data[0]['userfield']->placeholder) ? wpjobportal::$_data[0]['userfield']->placeholder : '', array('class' => 'inputbox one wpjobportal-form-input-field','maxlength'=>225)),WPJOBPORTAL_ALLOWED_TAGS); ?></div>
                </div>
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo esc_html(__('Description', 'wp-job-portal')); ?></div>
        ...
        <?php
            $inline_js_script = "
                ...
                // to enable disbale show on listing field for resume sections (also handling visible fields from this.)
                function disableListingField() {
                    var section_val = jQuery('#section').val();
                    if(section_val != 1){
                        jQuery('#showonlisting').val(0);
                        jQuery('#showonlisting').attr('disabled',true);
                    }else{
                        jQuery('#showonlisting').attr('disabled',false);
                    }
