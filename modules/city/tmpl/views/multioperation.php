...
/**
* @param wp-job-portal Multioperation
*/
?>
<div id="wpjobportal-page-quick-actions">
    ...
    <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" confirmmessage="<?php echo esc_html(__('Are you sure to delete','wp-job-portal')).' ?'; ?>" data-for="removecity" href="#" title="<?php echo esc_html(__('delete', 'wp-job-portal')); ?>">
